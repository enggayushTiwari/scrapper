...
def run_enrichment():
    ...
    # Data Loading
    target_file = 'nashik_road_leads_raw.csv'
    try:
    ...
    if not tier_1_df.empty:
        tier_1_df.to_csv('Tier_1_NashikRoad_No_Website.csv', index=False, encoding='utf-8-sig')
    ...
    if struggling_sites:
        ...
        broken_df.to_csv('Tier_2_NashikRoad_Broken_Sites.csv', index=False, encoding='utf-8-sig')
        print(f"\n--- Output Phase 3 ---")
    ...
    if valid_sites:
        ...
        if outdated_sites:
            ...
            outdated_df.to_csv('Tier_3_NashikRoad_Outdated_Sites.csv', index=False, encoding='utf-8-sig')
            print(f"\n--- Output Phase 4 ---")
